...
void main() {
  ...
  group('Now Playing Movies', () {
    test(
      ...
      /* workaround to test List in const Right. Issue: https://github.com/spebbe/dartz/issues/80 */
  ...
  group('remove get_watchlist_movies', () {
    test('should return success message when remove successful', () async {
      ...
      when(mockLocalDataSource.removeWatchlistMovie(testMovieTable))
          .thenAnswer((_) async => 'Removed from get_watchlist_movies');
      // act
      final result = await repository.removeWatchlist(testMovieDetail);
      // assert
      expect(result, const Right('Removed from get_watchlist_movies'));
    });

    test('should return DatabaseFailure when remove unsuccessful', () async {
      // arrange
      when(mockLocalDataSource.removeWatchlistMovie(testMovieTable)).thenThrow(
          DatabaseException('Failed to remove get_watchlist_movies'));
      // act
      final result = await repository.removeWatchlist(testMovieDetail);
      // assert
      expect(result,
          const Left(DatabaseFailure('Failed to remove get_watchlist_movies')));
    });
  });

  group('get get_watchlist_movies status', () {
